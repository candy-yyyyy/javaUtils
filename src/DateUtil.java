...
public class DateUtil {
	 ...
	 * @Description: 得到指定月后（前）的日期 参数传负数即可
	 * @param date
	 *            指定日期
	 * @param month
	 *            月份偏移量
	...
	* @param returnType  返回值类型{0天, 1时, 2分, 3秒}
	* @return long 返回值为：{天, 时, 分, 秒}
	* @throws java.text.ParseException
	*/
	public static long getDistanceTimes(String str1, String str2, String returnType) throws java.text.ParseException {
